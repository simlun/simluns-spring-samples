...
* Shows how Java and "Groovy":http://groovy.codehaus.org/ can be used together in the same project.
...
** FreeMarker IDE
* From the Groovy Update Site (@http://dist.springsource.org/release/GRECLIPSE/e3.7/@)
** Groovy-Eclipse
